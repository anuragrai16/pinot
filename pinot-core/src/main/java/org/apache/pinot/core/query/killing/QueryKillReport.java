...
public final class QueryKillReport {
   ...
   */
  public QueryKillReport(long requestId, String queryId, String tableName, String strategyName,
      String triggeringMetric, long actualValue, long thresholdValue, String configSource,
